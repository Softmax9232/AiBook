      ...
      <Container className={styles.footer}>
        <Row>
          <Col xs={6} sm={{ span: 5, order: 1 }} lg={{ span: 3, order: 1 }}>
            <p className="Xsmall">
              DataGraphs is an open source project designed and developed by{' '}
              <a
          ...
          >
            <p>
              <BsFillEnvelopeFill /> hello at DataGraphs.io
            </p>
            <p>
              <FaTwitter />{' '}
              <a
                href="https://twitter.com/passionbytes"
                target="_blank"
                rel="noopener noreferrer"
              >
                @passionbytes
          ...
          >
            <p>
              <FaGithub />{' '}
              <a
                href="https://github.com/passionbytes"
                target="_blank"
                rel="noopener noreferrer"
              >
                Github
